...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import GLPK_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("e8aa6df9-e6ca-548a-97ff-1f85fc5b8b98"))
platforms = [Pkg.Artifacts.unpack_platform(e, "GLPK", artifacts_toml) for e in artifacts["GLPK"]]
...
if best_platform === nothing
    @debug("Unable to load GLPK; unsupported platform $(triplet(platform_key_abi()))")
else
